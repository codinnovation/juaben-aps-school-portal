    ...
    <>
      <div className={styles.mainbodyContainer}>
        <div className={styles.mainbodyBoxes}>
          ...
          <Link
            href="/admin_portal/workersRegistration/"
          ...
          <Link
            href="/admin_portal/teacherRegistration/"
            style={{ textDecoration: "none" }}
          >
            <div className={styles.box}>
              <div className={styles.boxIcon}>
          ...
          <Link
            href="/admin_portal/notifications/notificationParents"
          ...
          <Link
            href="/admin_portal/notifications/notificationTeacher"
            style={{ color: "white", textDecoration: "none" }}
          >
            <div className={styles.box}>
              <div className={styles.boxIcon}>
          ...
          <Link
            href="/admin_portal/create_event/"
            style={{ color: "white", textDecoration: "none" }}
          >
            <div className={styles.box}>
              <div className={styles.boxIcon}>
