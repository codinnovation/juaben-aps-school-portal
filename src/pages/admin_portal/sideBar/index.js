        ...
        <div className={styles.container_items}>
          ...
          <div className={styles.container_items_4}>
            <div className={styles.container_items_4_items}>
              ...
              <div className={styles.container_items_4_link}>
                <PeopleIcon className={styles.container_items_4_icon} />
                <Link href="/admin_portal/teacherList/" className={styles.link}>
                  Teacher&apos;s List
                </Link>
              </div>
              ...
              <div className={styles.container_items_4_link}>
                <PeopleIcon className={styles.container_items_4_icon} />
                <Link
                  href="/admin_portal/non_staff_list/"
                  className={styles.link}
                >
                  Non Teaching Staff
                </Link>
              ...
              <div className={styles.container_items_4_link}>
                ...
                />
                <Link
                  href="/admin_portal/parentNotification/"
                  className={styles.link}
                >
              ...
              <div className={styles.container_items_4_link}>
                ...
                <Link
                  href="/admin_portal/setStudentFees/"
                  className={styles.link}
                >
                  Student&apos;s Fees
                </Link>
