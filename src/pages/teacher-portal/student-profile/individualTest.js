...
function StudentClassScore({ selectedStudent, usersTeachers }) {
  ...
  const addSubjectScores = () => {
    ...
    const scoreRef = ref(
      db,
      `/japsstudents/${selectedStudent.key}/individualTest/${selectedTerm}/${selectedSubject}`
    );
    push(scoreRef, {
      score: subjectScore,
      date: subjectDate,
  ...
  const updateSubjectScore = () => {
    ...
    const scoreRef = ref(
      db,
      `/japsstudents/${selectedStudent.key}/individualTest/${selectedTerm}/${editSubject}/${editScoreId}`
    );
