...
function StudentClassScore({ selectedStudent, usersTeachers }) {
  ...
  const addSubjectScores = () => {
    ...
    const scoreRef = ref(
      db,
      `/japsstudents/${selectedStudent.key}/groupwork/${selectedTerm}/${selectedSubject}`
    );
    push(scoreRef, {
      score: subjectScore,
      date: subjectDate,
  ...
  const updateSubjectScore = () => {
    ...
    const scoreRef = ref(
      db,
      `/japsstudents/${selectedStudent.key}/groupwork/${selectedTerm}/${editSubject}/${editScoreId}`
    );
